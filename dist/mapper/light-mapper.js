...
exports.mapHomeKitHueToAlexaValue = void 0;
...
const nearestColorMatcher = nearest_color_1.default.from(colorNames);
const mapHomeKitHueToAlexaValue = (hue) => { var _a; return O.fromNullable((_a = nearestColorMatcher(hslToRgb(hue))) === null || _a === void 0 ? void 0 : _a.name); };
exports.mapHomeKitHueToAlexaValue = mapHomeKitHueToAlexaValue;
